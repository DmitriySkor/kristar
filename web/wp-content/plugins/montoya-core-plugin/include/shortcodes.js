(function() {
    tinymce.create('tinymce.plugins.MontoyaCoreShortcodes', {
        init : function(ed, url) {
            ed.addButton('clapat_shortcode_button', {
				type: 'menubutton',
				text: 'M',
				title: 'Insert Montoya Shortcode',
                icon: false,
					...
					// Elements
					{
                        ...
                        menu: [
							...
							
							{
								text: 'List Rotator',
								onclick: function () {
										tb_show("Add List Rotator", ShortcodeAttributes.shortcode_folder + '/shortcodes_popup.php?&sc=list_rotator&width=700&height=600');
								}
							},
							
							{
								text: 'Flex List',
								onclick: function () {
										tb_show("Add Flex List", ShortcodeAttributes.shortcode_folder + '/shortcodes_popup.php?&sc=flex_list&width=700&height=600');
								}
							},
							...
							
							{
								text: 'Parallax Image',
								onclick: function () {
									tb_show("Add Parallax Image", ShortcodeAttributes.shortcode_folder + '/shortcodes_popup.php?&sc=clapat_parallax_image&width=400&height=500');
								}
							},
							
							{
								text: 'Clipped Image',
								onclick: function () {
									tb_show("Add Clipped Image", ShortcodeAttributes.shortcode_folder + '/shortcodes_popup.php?&sc=clapat_clipped_image&width=400&height=500');
								}
							},
							...
							
							{
								text: 'Portfolio Grid',
								onclick: function () {
									tb_show("Add portfolio grid", ShortcodeAttributes.shortcode_folder + '/shortcodes_popup.php?&sc=montoya_portfolio_grid&width=400&height=500');
								}
							},
							
							{
								text: 'News',
								onclick: function () {
									tb_show("Add news list", ShortcodeAttributes.shortcode_folder + '/shortcodes_popup.php?&sc=montoya_news&width=400&height=500');
								}
							},
						]
					},
		...
		getInfo: function () {
            return {
				...
				longname: 'Montoya Shortcodes',
                author: 'ClaPat Studio',
                authorurl: 'http://themeforest.net/user/clapat/',
                infourl: 'http://clapat-themes.com/wordpress/montoya/',
                version: "1.0"
            }
        }
    });
    // Register plugin
    tinymce.PluginManager.add( 'MontoyaCoreShortcodes', tinymce.plugins.MontoyaCoreShortcodes );
})();