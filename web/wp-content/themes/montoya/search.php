		...
		<div id="hero">
			<div id="hero-styles">
				<div id="hero-caption" class="content-full-width parallax-scroll-caption text-align-center">
					<div class="inner">
						<h1 class="hero-title caption-timeline primary-font-title"><span><?php echo get_search_query(); ?></span></h1>
						<div class="hero-subtitle caption-timeline"><span><?php echo esc_html__( 'Search Results', 'montoya'); ?></span></div>
					</div>
				</div>
			</div>
		</div>
				...
				<div id="blog-effects" class="<?php echo sanitize_html_class( montoya_get_theme_options( 'clapat_montoya_blog_scroll_effect_type' ) ); ?>" data-fx="1">
					<?php
						...
						if( have_posts() ){
							...
							echo '<h4 class="search_results">' . esc_html__('No posts found', 'montoya') . '</h4>';
